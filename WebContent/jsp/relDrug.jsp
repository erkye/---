...
<body>
<input type="hidden" value="${relresult }" id="resulthidden">
	...
	<center>
		<div class="panel panel-default" style="width: 45%;">
			...
			<div class="panel-heading">
				<font size="4"><b>修改药品信息</b></font>
			</div>

			<form action="/Drugsmanagement/RelDrugServlet" method="post">
				...
				<table class="table table-striped table-hover">
					<tr align="center">
						...
						<td><input type="text" class="form-control"
							placeholder="请输入药品名称" name="dname" id="dname" value="${drug.dname }"></td>
					</tr>
					<tr align="center">
						<td>生产厂家</td>
						<td><input type="text" class="form-control"
							placeholder="请输入生产厂家" name="dfactory" id="dfactory" value="${drug.dfactory }"></td>
					</tr>
					<tr align="center">
						<td>生产日期</td>
						<td><input type="date" class="form-control" name="dpdate" id="dpdate" value="${drug.dpdate }">
						</td>
					</tr>
					<tr align="center">
						<td>保质期</td>
						<td><input type="text" class="form-control"
							placeholder="请输入保质期" name="dperiod" id="dperiod" value="${drug.dperiod }"></td>
					</tr>
					<tr align="center">
						<td align="center">用途</td>
						<td><textarea class="form-control" rows="3" name="dpurpose" id="dpurpose">${drug.dpurpose }</textarea>
						</td>
					</tr>
					<tr align="center">
						<td>价格</td>
						<td><input type="text" class="form-control"
							placeholder="请输入价格" name="dprice" id="dprice" value="${drug.dprice }"></td>
					</tr>
					<tr align="center">
						<td>存放位置</td>
						<td><input type="text" class="form-control"
							placeholder="请输入存放位置" name="dposition" id="dposition" value="${drug.dposition }"></td>
					</tr>
					<tr align="center">
						<td>库存数量</td>
						<td><input type="text" class="form-control"
							placeholder="请输入库存数量" name="dnums" id="dnums" value="${drug.dnums }"></td>
					</tr>
					<tr align="center">
						<td colspan="2">
