...
<input type="hidden" value="${insertresult }" id="resulthidden">
	...
	<center>
		<div class="panel panel-default" style="width: 45%;">
			...
			<form action="/Drugsmanagement/InsertOutHouseServlet" method="post">
			<input type="hidden" name="sid" value="0">
				...
				<table class="table table-striped table-hover">
					<tr align="center">
						<td>药品名称</td>
						<td>
						<select class="form-control" name="odid" id="drugid">
					...
					<tr align="center">
						...
						<td><input type="text" class="form-control"
							placeholder="请输入数量,当前库存量：" name="onum" id="nums">
							</td>
					</tr>
					<tr align="center">
						<td>出库时间</td>
						<td><input type="date" class="form-control" name="odate" id="outtime">
						</td>
					</tr>
					<tr align="center">
						<td>购买客户</td>
