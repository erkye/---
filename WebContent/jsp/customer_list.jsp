...
<script type="text/javascript">
	$(function() {
		$("#insertbutton").click(function() {
			window.location.href = "/Drugsmanagement/jsp/insertCustomer.jsp";
		});
		...
		$(".deleteDrug").on('click',function() {
			...
			if (flag) {
			//js里面的页面跳转
			window.location.href = "/Drugsmanagement/DeleteCustomerServlet?cid="+ cid;
			}
		...
		$(".reDrug").on('click',function() {
			...
			var cid = $(this).val();
			window.location.href = "/Drugsmanagement/CustomerDisplayServlet?cid="+ cid;
		});
	});
</script>
</head>
	...
	<center>
		<div class="panel panel-default" style="width: 60%;">
			...
			<div class="panel-heading">
				<font size="4"><b>客户信息表</b></font>
				<form class="navbar-form" action="CustomerFuzzyQueryServlet"
					method="post">
					<div class="form-group">
						客户姓名：<input type="text" class="form-control" placeholder="请输入客户姓名"
							name="customername">
					</div>
					&nbsp; &nbsp; &nbsp;
					&nbsp; &nbsp; &nbsp;
				...
				<button type="button" class="btn btn-primary" id="insertbutton">添加新的客户信息</button>
			</div>
					...
					<tr align="center">
						...
						<td>
							<button type="button" class="btn btn-danger deleteDrug"
								value="${customer.cid }">删除</button>&nbsp;&nbsp;
							<button type="button" class="btn btn-primary reDrug"
								value="${customer.cid }">修改</button>
						</td>
					</tr>
				</c:forEach>
			</table>
