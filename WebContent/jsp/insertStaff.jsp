	...
	<center>
		<div class="panel panel-default" style="width: 45%;">
			...
			<div class="panel-heading">
				<font size="4"><b>添加员工</b></font>
			</div>

			<form action="/Drugsmanagement/insertStaffServlet" method="post">
				...
				<table class="table table-striped table-hover">
					<tr align="center">
						...
						<td><input type="text" class="form-control"
							placeholder="请输入员工姓名" name="sname" id="sname"></td>
					</tr>
					<tr align="center">
						<td>性别</td>
						<td align="left">
  						  ...
  						  <label class="radio-inline">
        					<input type="radio" name="ssex" id="ssex3"  value="保密"  checked>保密
  						  </label>
						</td>
					</tr>
					<tr align="center">
						<td>年龄</td>
						<td><input type="text" class="form-control"
							placeholder="请输入年龄" name="sage" id="sage"></td>
					</tr>
					<tr align="center">
						...
						<select class="form-control" name="seducation" id="seducation">
							...
							<option value="硕士即以上">硕士即以上</option>
