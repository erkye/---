	...
	<head>
		...
		$(function(){
			$("#insertbutton").click(function(){
				window.location.href="/Drugsmanagement/jsp/insertDrug.jsp";
			});
			if($("#resulthidden").val() != ""){
			...
			$(".deleteDrug").on('click', function(){
				...
				if(flag){
					//js里面的页面跳转
					window.location.href = "/Drugsmanagement/DeleteDrugServlet?did="+did;
				}
			...
			$(".reDrug").on('click',function(){
				...
				var did = $(this).val();
				window.location.href = "/Drugsmanagement/DrugDisplayServlet?did=" + did;
			});
		});
		</script>
	</head>
		...
		<center>
			<div class="panel panel-default" style="width: 90%;">
				...
				<div class="panel-heading">
					<font size="4"><b>药品信息表</b></font>
					<form class="navbar-form" action="DrugFuzzyQueryServlet" method="post">
						...
						&nbsp;
						<div class="form-group">
							生产厂家：<input type="text" class="form-control" placeholder="请输入生产厂家" name="drugfactory">
						</div>
						&nbsp;
						&nbsp;
						&nbsp;
						<div class="form-group">
							库存位置：<input type="text" class="form-control" placeholder="请输入库存位置" name="drugposition">
						</div>
						&nbsp;
						&nbsp;
						&nbsp;
					...
					<button type="button" class="btn btn-primary" id="insertbutton">添加新的药品信息</button>
				</div>
				...
				<table class="table table-striped table-hover">
					...
					<tr align="center">
						...
						<td>${drug.dpurpose }</td>
						<td>${drug.dprice }</td>
						<td>${drug.dposition }</td>
						<td>${drug.dnums }</td>
						<td>
						<button type="button" class="btn btn-danger deleteDrug" value="${drug.did }">删除</button>&nbsp;&nbsp;
						<button type="button" class="btn btn-primary reDrug" value="${drug.did }">修改</button></td>
					</tr>	
					</c:forEach>
				</table>
			</div>
